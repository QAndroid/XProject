...
class SubInfoRepository : SubInfoDataSource {

    companion object {
        private const val SERVICE_LATENCY_IN_MILLIS: Long = 1000
        private var SUBSCRIBE_SERVICE_DATA: MutableMap<String, SubInfo> = LinkedHashMap(2)
        private var TAG_SERVICE_DATA: MutableMap<String, SubInfo> = LinkedHashMap(2)
        private var FILTER_SERVICE_DATA: MutableMap<String, SubInfo> = LinkedHashMap(2)

        private var INSTANCE: SubInfoRepository? = null
        /**
         * 获取已订阅发布者远程数据源单例对象
         *
         * @return 远程数据源对象
