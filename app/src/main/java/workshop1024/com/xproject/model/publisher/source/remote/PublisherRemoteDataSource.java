...
public class PublisherRemoteDataSource implements PublisherDataSource {
    ...
    static {
        ...
        addPublisher("002", "Tech", "English", "/imag1", "Engadget", "1348433 subscribers", false, "/imag1", "300+");
        ...
        addPublisher("005", "Tech", "English", "/imag1", "Digital Trends", "145694 subscribers", false, "/imag1",
                "700+");
        ...
        addPublisher("008", "Tech", "中文", "/imag1", "36氪", "125345 subscribers", false, "/imag1", "200+");
        ...
        addPublisher("102", "News", "English", "/imag1", "Engadget", "1348433 subscribers", false, "/imag1", "300+");
        ...
        addPublisher("105", "News", "English", "/imag1", "Digital Trends", "145694 subscribers", false, "/imag1",
                "700+");
        ...
        addPublisher("108", "News", "中文", "/imag1", "腾讯新闻", "125345 subscribers", false, "/imag1", "200+");
        addPublisher("109", "News", "English", "/imag1", "TechCrunch", "994287 subscribers", false, "/imag1", "100+");

        addPublisher("201", "Business", "English", "/imag1", "The Business", "970601 subscribers", false, "/imag1",
                "500+");
        addPublisher("202", "Business", "English", "/imag1", "The New York Times", "1348433 subscribers", false,
                "/imag1", "300+");
        ...
        addPublisher("206", "Business", "English", "/imag1", "NRP News", "331892 subscribers", false, "/imag1",
                "100+");
        addPublisher("207", "Business", "中文", "/imag1", "财经周刊", "254321 subscribers", false, "/imag1", "200+");
        addPublisher("208", "Business", "中文", "/imag1", "交易时刻", "125345 subscribers", false, "/imag1", "200+");
        ...
        addPublisher("302", "Health", "English", "/imag1", "Skinnytaste", "1348433 subscribers", false, "/imag1",
                "300+");
        ...
        addPublisher("304", "Health", "English", "/imag1", "Mark's Daily Apple", "254332 subscribers", false,
                "/imag1", "400+");
        addPublisher("305", "Health", "English", "/imag1", "Oh She Glows", "145694 subscribers", false, "/imag1",
                "700+");
        addPublisher("306", "Health", "English", "/imag1", "Health", "331892 subscribers", false, "/imag1",
                "100+");
        addPublisher("307", "Health", "中文", "/imag1", "健康之路", "254321 subscribers", false, "/imag1", "200+");
        addPublisher("308", "Health", "中文", "/imag1", "星星点灯", "125345 subscribers", false, "/imag1", "200+");
        addPublisher("309", "Health", "English", "/imag1", "NYT", "994287 subscribers", false, "/imag1", "100+");


        addPublisher("401", "Gaming", "English", "/imag1", "The Gaming", "970601 subscribers", false, "/imag1",
                "500+");
        addPublisher("402", "Gaming", "English", "/imag1", "Polygon", "1348433 subscribers", false, "/imag1", "300+");
        ...
        addPublisher("505", "Gaming", "English", "/imag1", "IndieGames", "145694 subscribers", false, "/imag1",
                "700+");
        ...
        addPublisher("607", "Gaming", "中文", "/imag1", "电竞世界", "254321 subscribers", false, "/imag1",
                "200+");
        addPublisher("608", "Gaming", "中文", "/imag1", "一起游戏", "125345 subscribers", false, "/imag1", "200+");
