...
public class NewsRepository implements NewsDataSource {
    ...
    static {
        ...
        addNews("n001", "/image1", "news 001 title", "tom", "20180406", false);
        addNews("n002", "/image1", "news 002 title", "mike", "20180405", false);

        addNews("n003", "/image1", "news 003 title", "lilei", "20180306", false);
        addNews("n004", "/image1", "news 004 title", "hanmeimei", "20180206", false);
        addNews("n005", "/image1", "news 005 title", "sunny", "20170406", false);

        addNews("n006", "/image1", "news 006 title", "tom", "20160406", false);
        addNews("n007", "/image1", "news 007 title", "hanmeimei", "20110806", false);

        addNews("n008", "/image1", "news 008 title", "sunny", "20120407", false);

        addNews("n009", "/image1", "news 009 title", "lilei", "20161006", false);
    ...
    private static void addNews(String newId, String bannerUrl, String title, String author, String pubDate, boolean isReaded) {
        News news = new News(newId, bannerUrl, title, author, pubDate, isReaded);
