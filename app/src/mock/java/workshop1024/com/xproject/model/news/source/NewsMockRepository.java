...
public class NewsMockRepository implements NewsDataSource {
    ...
    private static NewsMockRepository INSTANCE;

    static {
        NEWSES_SERVICE_DATA = new LinkedHashMap<>(2);
        addNews("n001", "/image1", "news 001 title-mock", "tom", "20180406", false, false);
        ...
        addNews("n004", "/image1", "news 004 title-mock", "hanmeimei", "20180206", false, false);
        ...
        addNews("n008", "/image1", "news 008 title-mock", "sunny", "20120407", false, false);
        ...
        addNewsDetail("n001", "/image1", "news 001 title-mock", "The Tech", "20180406", "tom", "news 001 Contentnews 001 Content news 001 Content news 001 Content news 001 Content ", Arrays.asList("android", "ph", "rus", "american", "english", "american", "english", "e", "english"), false, false);
        ...
        addNewsDetail("n004", "/image1", "news 104 title-mock", "ReadWrite", "20180206", "hanmeimei", "news 004 Contentnews news 004 Contentnews news 004 Contentnews news 004 Contentnews ", Arrays.asList("usa"), false, false);
        ...
        addNewsDetail("n007", "/image1", "news 007 title-mock", "ReadWrite", "20180206", "hanmeimei", "news 007 Contentnews news 007 Contentnews news 007 Contentnews news 007 Contentnews ", Arrays.asList("usa"), false, false);
        ...
        addNewsDetail("n010", "/image1", "news 010 title-mock", "ReadWrite", "20180206", "mike", "news 010 Contentnews news 010 Contentnews news 010 Contentnews news 010 Contentnews ", Arrays.asList("usa"), false, false);
    }

    private NewsMockRepository() {
    ...
    public static NewsDataSource getInstance() {
        if (INSTANCE == null) {
            INSTANCE = new NewsMockRepository();
        }
        return INSTANCE;
    }
