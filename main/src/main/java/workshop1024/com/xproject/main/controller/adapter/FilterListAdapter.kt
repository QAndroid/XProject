...
class FilterListAdapter(private val mFilterList: List<workshop1024.com.xproject.main.model.filter.Filter>, private val mOnFilterListDeleteListener: OnFilterListDeleteListener?) : RecyclerView.Adapter<FilterListAdapter.FilterViewHolder>() {
    ...
    interface OnFilterListDeleteListener {
        fun filterListItemDelete(filter: workshop1024.com.xproject.main.model.filter.Filter)
    }
    ...
    inner class FilterHandlers {
        fun onClickDelete(view: View, filter: workshop1024.com.xproject.main.model.filter.Filter) {
